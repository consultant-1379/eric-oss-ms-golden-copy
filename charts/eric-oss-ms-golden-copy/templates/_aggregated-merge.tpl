...
*/ -}}
{{- define "eric-oss-ms-golden-copy.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-oss-ms-golden-copy.mergeAnnotations" -}}
  {{- include "eric-oss-ms-golden-copy.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-oss-ms-golden-copy.mergeLabels" -}}
  {{- include "eric-oss-ms-golden-copy.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
